...
def get_operation(a, b):
    ...
    if res_list[-2] == 'сложить':
        result = model_sum.do_it(a, b)
    elif res_list[-2] == 'вычесть':
        result = model_sub.do_it(a, b)
    elif res_list[-2] == 'умножить':
        result = model_mult.do_it(a, b)
    elif res_list[-2] == 'разделить':
        result = model_div.do_it(a, b)
